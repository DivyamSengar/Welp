...
const (
	ReservationService_MakeReservation_FullMethodName = "/reservation.ReservationService/MakeReservation"
	ReservationService_GetReservation_FullMethodName  = "/reservation.ReservationService/GetReservation"
	ReservationService_MostPopular_FullMethodName     = "/reservation.ReservationService/MostPopular"
)
...
func (c *reservationServiceClient) MakeReservation(ctx context.Context, in *MakeReservationRequest, opts ...grpc.CallOption) (*MakeReservationResponse, error) {
	...
	err := c.cc.Invoke(ctx, ReservationService_MakeReservation_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reservationServiceClient) MostPopular(ctx context.Context, in *MostPopularRequest, opts ...grpc.CallOption) (*MostPopularResponse, error) {
	...
	err := c.cc.Invoke(ctx, ReservationService_MostPopular_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ReservationService_MakeReservation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReservationService_MakeReservation_FullMethodName,
	}
...
func _ReservationService_MostPopular_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReservationService_MostPopular_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
